            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <h2 className="text-4xl md:text-5xl lg:text-4xl font-bold text-black mb-6 leading-tight">
                  Design that communicates. Branding that connects.
                </h2>
                <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                  Your website and brand are often the first impression of your business.
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Fast, responsive, and conversion-focused websites</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <img src="/YERROW.png" alt="" />
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Clean, intuitive, and user-centric digital experiences</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <img src="/YERROW.png" alt="" />
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Logos, brand identity, and visual systems</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <img src="/YERROW.png" alt="" />
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Online stores with seamless payment integration</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <img src="/YERROW.png" alt="" />
    ...
    `}} />
              <div className="flex slider-infinite">
                {[
                  ...
                  { name: "Anas Ansari", role: ["Web & App Developer", "SEO Expert"], image: "/IMG-20241207-WA0010.jpg" },
                      ...
                      <div className="relative w-full h-92 rounded-2xl overflow-hidden bg-yellow-300">
                        ...
                        <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 w-[85%] bg-[#DFF2E1] rounded-b-3xl rounded-t-3xl px-2 py-2 text-center">
                          ...
                          <p className="text-sm text-gray-700">
                            {member.role.map((line, lineIndex) => (
                              <span key={`${member.name}-${lineIndex}`} className="block">
                                {line}
                              </span>
                            ))}
                          </p>
